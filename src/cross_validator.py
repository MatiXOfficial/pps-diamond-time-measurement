...
class CrossValidator:
    def __init__(self, model_builders: List[Callable[[], keras.Model]], x: np.ndarray, y: np.ndarray,
                 ...
                 n_epochs: int = 3000, es_patience: int = 50, es_min_delta: float = 0.01, reduce_patience: int = 10, batch_size: int = 2048,
...
class KerasTunerCrossValidator(CrossValidator):
    def __init__(self, tuner: kt.Tuner, x: np.ndarray, y: np.ndarray,
                 ...
                 es_min_delta: float = 0.01, reduce_patience: int = 10, batch_size: int = 2048, n_top: int = 5, n_cv: int = 5,
