...
OUTPUT_PATH = f'/scripts/unet_tuning_ch10/output/{i_param}'
RESULTS_PATH = '/scripts/unet_tuning_ch10/output/'
WEIGHTS_PATH = f'/scripts/model_weights/unet_tuning_ch10/{i_param}'
