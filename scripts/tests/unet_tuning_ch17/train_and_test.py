...
OUTPUT_PATH = f'/scripts/unet_tuning_ch17/output/{i_param}'
RESULTS_PATH = '/scripts/unet_tuning_ch17/output/'
WEIGHTS_PATH = f'/scripts/model_weights/unet_tuning_ch17/{i_param}'
